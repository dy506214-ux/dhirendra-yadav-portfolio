    ...
    <div id="experience" className="max-w-4xl mx-auto px-6 pt-32 relative z-10 scroll-mt-20">
      <div className="space-y-4 mb-16 text-center">
        <AnimatedHeading as="h1" className="text-5xl md:text-6xl font-bold text-white tracking-tight">
          <TypingAnimation text="My Experience" delay={0.1} highlight="Experience" />
        </AnimatedHeading>
      ...
      {experiences.length === 0 ? (
        <div className="text-center py-20 glass-card rounded-3xl">
          <AnimatedHeading as="h2" className="text-2xl text-gray-400">No experience added yet.</AnimatedHeading>
        </div>
      ) : (
