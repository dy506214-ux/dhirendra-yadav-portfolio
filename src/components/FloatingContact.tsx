...
export default function FloatingContact() {
  ...
  return (
    <div className="fixed bottom-20 right-4 sm:bottom-6 sm:right-6 flex flex-col items-center gap-4 z-[999]">
      ...
      <AnimatePresence>
        {showScrollTop && (
          <motion.button
            ...
            onClick={scrollToTop}
            className="bg-white/10 backdrop-blur-md text-white p-3 rounded-full shadow-lg border border-white/20 hover:border-neon-blue hover:text-neon-blue transition-all flex items-center justify-center group mb-2"
            title="Scroll to Top"
          >
